...
public:
    ...
    {
        std::string tag;
        uint32_t ID = 0;  // Initialize ID to ensure it's never uninitialized
    };
...
private:
	...
	//	Preloads textures for use in the scene
	void LoadSceneTextures();

	//	Defines the lighting information presets that can be applied to diferent object models
	void DefineObjectMaterials();

	//	prepares the scene for the lighting dources defines within
